    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e("url fire","http://code.yakshaq.in/android/chat.php?mess="+messa+"&id="+id);
                if(!messa.isEmpty())
                    try {
                        new DownloadTask().execute("http://code.yakshaq.in/android/chat.php?mess=" + URLEncoder.encode(messa, "UTF-8") + "&id=" + id);
                    }catch (Exception e){}
        ...
        new DownloadTask().execute("https://api.mongolab.com/api/1/databases/swachh/collections/chat?f=%7B%22_id%22%3A0%2C%22chat_data%22%3A1%2C%22case_data.progress_scale%22%3A1%2C%22case_data.title%22%3A1%2C%22case_data.case_id%22%3A1%7D&apiKey=oiFA2wjAg4tcIzjfQnfWBrj_Y4RO4GqP");
                    ...
                    for (int i = 0; i < jarray.length(); i++) {
                        ...
                        for (int j = 0; j < arr.length(); j++) {
                            ...
                            if (sender.equals(session.user())) {
                                ...
                                mss.setFromName("Worker Id" + sender);
                                mss.setSelf(false);
                                mss.setMessage(mani.getString("message"));
